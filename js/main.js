...
let index = -1;
let sound= new Audio(carpetaIMG + "risa.mp3")
btnSi.addEventListener('click', function () {
    Swal.fire({
        title: 'Que sera,',
        text: 'Que sera?!!!',
        imageUrl: carpetaIMG + 'ruleta.gif',
        confirmButtonText: 'Obrir regal'
        ...
        mensaje.textContent = 'Una mierda empapela (Vuelve a intentarlo el proximo año)';
    });
});
